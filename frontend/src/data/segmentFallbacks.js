export const FALLBACK_SEGMENTS = [
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1715605569694-4cc47c9fb535?auto=format&fit=crop&w=960&q=70',
    icon: 'Battery',
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1765272088009-100c96a4cd4e?auto=format&fit=crop&w=960&q=70',
    icon: 'Zap',
  ...
  },
  {
    ...
    id: 'ev-passenger-fleets',
    slug: 'ev-passenger-fleets',
    name: 'EV Passenger Fleets',
    description: 'Invest in electric passenger mobility fleets serving airport routes, urban ride-hailing corridors, and premium shuttle operations.',
  ...
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1733187633171-3b1c0c6ce708?auto=format&fit=crop&w=960&q=70',
    icon: 'Server',
    features: ['100% Renewable Energy', 'PUE < 1.2', 'Tier 4 Certified', 'Edge Computing Ready'],
    total_tvl: 45000000,
    investors_count: 2847,
    apy_range: { min: 8, max: 15.5 },
    risk_level: 'Medium',
    min_investment: 100,
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1755585129999-7b29cf3baebe?auto=format&fit=crop&w=960&q=70',
    icon: 'Sun',
    features: ['20+ Year PPAs', 'Carbon Neutral', 'Government Incentives', 'Diversified Portfolio'],
    total_tvl: 67000000,
    investors_count: 4156,
    apy_range: { min: 7.5, max: 14.5 },
    risk_level: 'Low',
    min_investment: 200,
  },
  {
    ...
    image_url: 'https://images.unsplash.com/photo-1683444595829-e74e68fcce22?auto=format&fit=crop&w=960&q=70',
    icon: 'Leaf',
    features: ['Verified Credits', 'Biodiversity Projects', 'Corporate Partnerships', 'Transparent Tracking'],
    total_tvl: 18000000,
    investors_count: 1287,
    apy_range: { min: 6, max: 12 },
    risk_level: 'Medium',
    min_investment: 100,
  },
];
